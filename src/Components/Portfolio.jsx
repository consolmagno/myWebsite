  ...
  return(
    <div className={styles.section_portfolio}>
          ...
          <div className={styles.cards}>
            ...
            <Card title='Gaya Construtora' image={website_gaya} tag_title='web' tag_title_2='Data: 2023' btn_link= "https://www.figma.com/proto/uP74vKKyTUAr24VJTd9bYt/Untitled?page-id=0%3A1&node-id=4-3&viewport=975%2C472%2C0.15&scaling=min-zoom&starting-point-node-id=4%3A3"/>
